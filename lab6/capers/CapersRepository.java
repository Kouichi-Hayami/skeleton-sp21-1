...
public class CapersRepository {
    ...
    static final File CAPERS_FOLDER = Utils.join(CWD, ".capers"); //  Creates a File object (a reference)
                                            //      function in Utils
    ...
    public static void setupPersistence() {
        ...
        {
            CAPERS_FOLDER.mkdirs();//now we create the real folder
        }
    ...
    public static void makeDog(String name, String breed, int age) {
        ...
        newDog.saveDog();                       // Step 2: save to disk
